...
if __name__ == "__main__":
    ...
    st.set_page_config(
        page_title="S&P500 Screener & Stock Prediction",
        layout="centered",
        page_icon="📈",
    ...
    with col_prediction_2:
        with st.expander("Explication de la prédiction",expanded=True):
            st.write("""
                Le graphique ci-dessus montre l'évolution du cours de l'action sélectionnée entre le 31 déc. 2011 et 31 déc. 2021. L'indicateur de gauche est la valeur du cours de l'action au 31 décembre. 2021 pour l'entreprise sélectionnée et son évolution entre le 31 déc. 2011 et 31 déc. 2021.
                ⚠️⚠️ Ces valeurs sont calculées en fonction de ce que l'API Yahoo Finance renvoie !
            """)
